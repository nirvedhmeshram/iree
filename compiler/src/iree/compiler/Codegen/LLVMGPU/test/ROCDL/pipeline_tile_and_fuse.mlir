...
// CHECK:          vector.transfer_write {{.*}} : vector<4x1x2x8x1xi8>, memref<8x16x4x8x2xi8, strided<[50176, 3136, 16, 2, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
// CHECK:          vector.transfer_write {{.*}} : vector<2x8x1x4x1xi8>, memref<4x8x2x8x16xi8, strided<[4096, 512, 256, 16, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
